<?php
    ...
    if(isset($_POST['update_profile'])){
        ...
        $sql = " UPDATE users SET username = '$update_username',
            ...
            departement = '$update_departement', sexe = '$update_sexe',
...
<head>
    ...
    <link rel="stylesheet" href="Updateprofile.css" type="text/css">
    <title></title>
</head>
<body>
<?php
   ...
   <h1>Modifier mes informations :</h1>
       ...
       <div class="corps-formulaire">
            ...
            <div class="droite">
                ...
                <div class="groupe">
                    ...
                    <input type="text" name="update_departement" value="<?php echo $fetch['departement']; ?>">
                </div>
                <div class="groupe">
                    <label>Sexe :</label>
                    <input type="text" name="update_sexe" value="<?php echo $fetch['sexe']; ?>">
                </div>
                <div class="groupe">
                    <label>Email :</label>
       ...
       <div class="pied-formulaire" align="center">
            ...
            <input type="submit" value="Modifier profile" name="update_profile">
       </div>    
   </form>
</body>
</html>